...
Окно всегда забирает фокус: если внутри нечего фокусировать (окно подтверждения),
фокус берёт сама рама — иначе клавиши уходили бы в панели, а окно оставалось бы
глухим к Enter и Esc.
