...
| 8 | Ф7. Модуль-канарейка `dependency/navigation` | pending | 7 |
| 9 | Ф8. Настройки модулей: `ModuleSettings`/`SettingsScope` | pending | 7 |
| 10 | Ф9. Фоновые задачи и viewport панели | pending | 7 |
| 11 | Ф10. `dependency/file_ops` | pending | 5, 7 |
| 12 | Ф11. `dependency/zip_archiver` | pending | 4, 7 |
| 13 | Ф12. `dependency/default_theme` | pending | 6, 7, 9 |
