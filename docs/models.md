...
Две вещи, без которых потоковый перенос был бы опаснее старого:

- **отмена проверяется между кусками**, а не между файлами: файл может быть
  сколь угодно большим;
- **недописанный файл убирается** — и после ошибки, и после отмены. Половина
  файла под настоящим именем выглядит как целый файл.
