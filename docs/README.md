...
два списка модулей (`lib/bootstrap/app_modules.dart`) и два контейнера
зависимостей. Между сторонами — **линк**, и по нему ходят только значения:
...
flex_commander/                    корень воркспейса и само приложение
  lib/
    ...
    bootstrap/
      app_modules.dart             из чего собрано приложение — два списка
                                   модулей, ядровый и экранный
    ...
    modules/
      app_shell_backend.dart       оболочка ядра: движок операций, файловые
                                   работы
      app_shell_frontend.dart      оболочка экрана: справка, палитра, окно
                                   настроек
