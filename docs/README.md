...
5. **Действия — это команды**, а не обработчики в виджетах: команда описывает только
   ...
   **какими клавишами** и **где её показывают**: привязками заведует реестр, а кнопки
   ...
   привязки настраиваются, а любую команду можно выполнить из списка
...
dependency/
  ...
  attributes/                      fc_attributes — правка атрибутов: права,
                                   даты, владелец, расширенные (Ctrl-A)
  content_types/                   fc_content_types — что за файл на самом
                                   деле: тип по первым байтам, а не по имени
  file_icons/                      fc_file_icons — иконка строки по правилам:
                                   глиф, картинка с диска, значок системы
