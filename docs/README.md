...
- Файловые операции: копирование и перемещение (кнопки присутствуют, но неактивны —
  см. [`keyboard.md`](keyboard.md#статус-команд-в-mvp)). Создание каталога и удаление
  уже работают.
...
| 7 | `TreeEditor`: создание каталога и удаление (сделано), копирование и перемещение с прогрессом и запросами |
