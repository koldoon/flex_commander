...
/// Снимок вида «Значки»: сетка плиток, справа — таблица.
///
/// Обновление: `flutter test --update-goldens`.
void main() {
  testWidgets('сетка значков совпадает с эталоном', (tester) async {
    ...
    final settings = AppSettings(
      left: PanelSettings(path: '/Users/koldoon', view: IconsView.viewId),
    ...
    await expectLater(find.byType(FlexCommanderApp), matchesGoldenFile('goldens/panel_icons.png'));
