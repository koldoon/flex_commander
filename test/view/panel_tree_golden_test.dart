...
/// Снимок дерева: слева ветви от корня, справа обычная таблица.
///
/// Обновление: `flutter test --update-goldens`.
void main() {
  testWidgets('дерево совпадает с эталоном', (tester) async {
    ...
    final settings = AppSettings(
      left: PanelSettings(path: '/Users/koldoon/Documents', view: TreeView.viewId),
    ...
    await expectLater(find.byType(FlexCommanderApp), matchesGoldenFile('goldens/panel_tree.png'));
