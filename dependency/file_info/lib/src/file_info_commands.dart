        ...
        content: ListenableBuilder(
          ...
          builder:
              (context, _) => FcKeyValueTable(
                ...
                horizontal: true,
                // Плашек разделов здесь нет, хотя в панели они есть: плашка
                // тянется во всю ширину, а ширины у окна нет — рама меряет
                // содержимое, и лента вбок не даёт ей конца
                // (`docs/spec/dialog-body.md`). Либо плашки, либо лента; в
                // окне выбрана лента: значение бывает длиннее экрана.
