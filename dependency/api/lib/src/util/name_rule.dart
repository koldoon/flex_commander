...
/// границу и показывается в заголовке окна находок.
///
/// **Массовому переименованию он не достался**, хотя обещание и стояло здесь:
/// в режиме маски это правило сличает имя **целиком**, а поле «найти» ищет
/// подстроку, и третий режим внутри сломал бы поиск. Там живёт соседнее
/// значение тем же приёмом — [NameReplacement] (`docs/spec/multi-rename.md`,
/// §7).
///
