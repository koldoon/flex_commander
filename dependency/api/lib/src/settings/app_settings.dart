...
class AppSettings implements Serializable {
  ...
  ///
  /// Список записей, а не словарь «привязка → клавиша»: запись — это **пара**,
  /// и пустая клавиша в ней значит «клавиши нет вовсе», то есть выбор человека,
  /// а не отсутствие записи ([KeyOverride]). Словарь выразил бы такой выбор
