...
abstract class FcMetrics {
  ...
  ///
  /// Ставит его шелл и **всегда**: это внешняя рамка окна, и от того, занята
  /// ли полоса под панелями, она зависеть не должна. Полноэкранный
  /// просмотрщик отбит от кнопок ровно так же, как панели.
  double get functionBarGap;

  /// Воздух над командной строкой — между ней и рамкой панелей.
  ///
  /// Отдельно от [functionBarGap], хотя оба про просветы внизу окна. Пока это
  /// была одна величина, настроить их порознь было нельзя: подобрали по
  /// командной строке — разъехалась рамка в полноэкранном, где строки нет
  /// вовсе.
