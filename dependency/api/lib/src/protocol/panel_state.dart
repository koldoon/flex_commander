...
class PanelState {
  ...
  /// Раскладка колонок — та, что лежит в настройках панели: порядок, ширина и
  /// видимость. Объявления к ней прикладывает та сторона, которая рисует
...
class PanelListing {
  ...
  /// списку (`docs/spec/client-server.md`, §5.6.4). Ставит ядро только там,
