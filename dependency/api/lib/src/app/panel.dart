...
///
/// [Listenable] — часть контракта: панель уведомляет об изменениях, и подписаться
/// на неё может любой, кому она досталась как [Panel], — виджет ядра или
/// содержимое панели, нарисованное модулем.
