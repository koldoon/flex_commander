...
enum FsColumn {
  ...
  /// По колонке можно сортировать; значок сравнивать нечем.
  ///
  /// Ветвь сортируется наравне со всеми: колонка дерева — это колонка имени,
  /// нарисованная по-другому (`docs/spec/panel-node-list.md`, §5).
