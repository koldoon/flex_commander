...
class _BranchRow extends StatelessWidget {
  ...
  /// Знак раскрытия: у ветви — шеврон, у файла ничего.
  ///
  ...
  /// (`docs/spec/panel-view-tree.md`, §4). Ветвь — это и архив: раскрывается
  /// он так же, только открывается монтированием (§4б).
  String _mark(FcIcons icons) {
    ...
    //
    // Архив здесь не исключение, хотя в полном дереве знак у него стоит
    // сразу. Разница в том, что обещает знак: в дереве — «строка
    // раскрывается», а у навигатора — «внутри есть ветви», и про архив это
    // неизвестно, пока его не открыли. Обещанное нажатие обязано что-то
    // сделать, а раскрытый архив с одними файлами внутри в навигаторе
    // раскрывается в пустоту (`docs/spec/panel-view-tree.md`, §4б).
