...
class AgreeingShell {
  ...
  /// Встреча: приглашение после присланного уговора.
  ///
  /// Оно одно — уговор и `clear` приложение шлёт **одной строкой**, и на неё
  /// оболочка отвечает одним приглашением, уже с чистого экрана
