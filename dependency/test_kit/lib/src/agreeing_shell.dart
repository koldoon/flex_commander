...
class AgreeingShell {
  ...
  /// Встреча: приглашение после уговора и приглашение после `clear`.
  ///
  /// Их и правда два — приложение присылает свежей оболочке две строки, и на
  /// каждую она отвечает приглашением. Показывать её можно только после
  /// второго: до него на экране видна строка уговора.
  void greet({int code = 0}) {
    _prompt(code);
    finish(code: code);
  }
