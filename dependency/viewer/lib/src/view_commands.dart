...
class ViewFileCommand extends AppCommand {
  ...
  Future<void> execute(CommandContext context) async {
    ...
    try {
      ...
      // Прочитать не вышло — это ответ человеку, а не строка в журнале: он
      // нажал клавишу, и молчание читается как «клавиша сломана». Живьём так и
      // было: над находкой растущего списка `F3` не делал ничего.
