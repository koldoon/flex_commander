...
void main() {
  ...
  group('приглашение', () {
    ...
    test('на сервере видно, где выполнится набранное', () async {
      ...
      // Перечитывание, а не просто оборот очереди: снимок источника едет к
      // экрану вместе с состоянием панели, и подмена за спиной у ядра сама по
      // себе никому ничего не скажет. В жизни подпись меняется вместе с
