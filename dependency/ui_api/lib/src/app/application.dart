...
abstract interface class Application implements Listenable {
  ...
  /// Переназначенные клавиши — то, что человек выбрал в окне настройки клавиш
  /// (`docs/spec/key-bindings.md`).
  ///
  /// Настройка ядра по той же причине, что и заголовок панели: привязки
  /// приносят модули, а выбор человека живёт в общем файле и правится одним
  /// окном.
  List<KeyOverride> get keyOverrides;

  /// Заменить список целиком — он и есть выбор человека.
  ///
  /// Список полный: позвали с пустым — вернулись все умолчания. Приложение
