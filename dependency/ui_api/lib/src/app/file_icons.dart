...
class IconPicture extends FileIcon {
  const IconPicture(this.image, {this.content = false});

  final ImageProvider image;

  /// Это содержимое файла, а не значок его типа.
  ///
  /// Рисуются они по-разному, и разница не в прихоти. Значок нарисован с
  /// прозрачными полями и своей формой — трогать его нельзя. Миниатюра же
  /// прямоугольна целиком, до самого края, и прямой угол рядом со скруглёнными
  /// плашками читается чужим; поэтому её кроют маской со стандартным
  /// скруглением (`docs/spec/file-thumbnails.md`, §9).
  final bool content;
}
