...
sealed class SettingsField {
  ...
  /// открывает своё окно (`docs/spec/key-bindings.md`, §8). Отдельным видом, а
...
class SettingsKeys extends SettingsField {
  ...
  /// Клавиши в набор попадают **своим списком**, а не значением поля: набор
  /// сливает их по имени привязки — что он назвал, то и меняется, — а значение
  /// поля так не слить (`docs/spec/settings-presets.md`, §3).
  @override
