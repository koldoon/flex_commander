...
///
/// **Выбор в приложении делается [FcSelect]ом.** Переключатель занимает строку
/// на каждый вариант, и окно растёт вместе с их числом — а числа этого никто не
/// знает заранее: темы приносят модули, уровни сжатия зависят от упаковщика.
/// В приложении он сейчас не используется нигде и остаётся в наборе как
/// возможность; новых мест у него быть не должно (`docs/widgets.md`).
///
