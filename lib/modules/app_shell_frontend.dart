...
class AppShellFrontend implements FcFrontendModule {
  ...
  void installFrontend(FrontendRegistry registry) {
    ...
    //
    // **Объявлено не на той стороне, и это видно.** Спрашивают секрет
    // источники — zip, 7z, ssh, — то есть ядро; показывает окно эта сторона.
    // Пока контейнер один, оно работает; когда контейнеры разъедутся, ядро
