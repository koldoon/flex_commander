...
class CommandPaletteCommand extends AppCommand {
  ...
  Future<void> execute(CommandContext context) async {
    ...
    dialogId = view.showDialog(
      DialogSpec(
        // Без полосы заголовка: палитра называет себя сама — полем ввода с
        // подсказкой и списком под ним, — а `Commands` над ними повторяло бы
        // это второй раз и отнимало строку списка. Двигать её от этого нечем,
        // и не надо: живёт она ровно столько, сколько набирают.
        takesFocus: true,
        // Под верхним краем, а не посередине: находок по ходу набора то
        // больше, то меньше, и окно, растущее вокруг своей середины, дёргалось
        // бы обеими границами на каждую букву.
